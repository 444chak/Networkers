    ...
    <>
      <Space space="1rem">
        ...
        <Text>
          ...
          communication qui assure la transmission de données entre deux
          machines. Il garantit que les données envoyées par une machine
          arrivent bien à l&rsquo;autre machine, dans le bon ordre et sans
          erreur.
        </Text>
        ...
        <Text>
          TCP fonctionne en établissant une connexion entre deux machines
          avant de transmettre des données. Cette connexion est appelée{" "}
          <b>connexion TCP</b>. Elle est établie en trois étapes :

          <ol>
            <li>
              <b>Établissement de la connexion :</b> Les deux machines
              s&rsquo;échangent des paquets pour s&rsquo;assurer qu&rsquo;elles
              sont prêtes à communiquer.
            </li>
            <li>
